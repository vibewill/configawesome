...
{description = "take a screenshot to a selection", group = "hotkeys"}),
    ...
    awful.key({ altkey, "Control" }, "l", function () os.execute("betterlockscreen -l dim") end,
...
awful.key({ "Control" }, "space", function () kbdcfg.switch() end),
  ...
  --            {description = "brightness down", group = "hotkeys"}),
	...
	-- Startup apps
 -- awful.key({ modkey }, "a", function () os.execute("sh ~/.config/awesome/startup.sh") end,
    ...
    --rofi
    awful.key({ modkey }, "d", function ()
            os.execute(string.format("rofi -modi drun -show drun"))
        end,
        {description = "show rofi", group = "launcher"}),
    --
	 awful.key({ modkey }, "x", function ()
            os.execute("power-menu")
        end,
        {description = "show EXIT dialog", group = "launcher"}),
...
awful.rules.rules = {
    ...
    { rule = { type = "normal" },
      ...
      { rule_any = { class = { "Variety", "variety", "Yad", "yad" } },
      properties = { 
      floating = true,
      titlebars_enabled = true,
      placement = awful.placement.centered
 ...
 -- Fix picture in picture floating
...
{ rule_any = { class = { "subl", "Subl", "geany", "Geany", "atom", "Atom" } },
