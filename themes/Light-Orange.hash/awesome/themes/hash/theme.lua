...
theme.widget_main_color = "#f57900"
...
theme.fg_normal                                 = "#0c0c0c"
theme.fg_focus                                  = "#0c0c0c"
theme.color_tag                                 = "#f57900"
theme.fg_urgent                                 = theme.widget_main_color
theme.bg_normal                                 = "#F3E3BD"
theme.bg_focus                                  = "#F3E3BD"
...
s.mytaglist = awful.widget.taglist(s, awful.widget.taglist.filter.noempty, awful.util.taglist_buttons, {font = "Font Awesome 5 Solid 9", bg_focus = theme.border_focus, fg_focus = theme.fg_focus})
