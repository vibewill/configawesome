...
myStartupHook = do
  setWMName "xmonad"
  spawn     "pkill trayer ; trayer --edge top --align left --widthtype request --height 21 --alpha 0 --transparent true --monitor primary --width 3 --iconspacing 5 --tint 0xF3E3BD"
