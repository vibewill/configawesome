Config {
    ...
    -- , borderWidth = 0
       ...
       , sepChar = "$"
       , alignSep = "}{"
       , template = "<fc=#0c0c0c><fn=1>$trayer$<fc=#f9cda2></fc> $date$ <fc=#f9cda2></fc> <fc=#f57900><fn=1></fn></fc><fn=2> $wifi$</fn> $dynnetwork$ <fc=#f9cda2></fc> <fc=#f57900> </fc><fn=2>$vol$</fn><fn=4>%</fn> <fc=#f9cda2></fc> <fc=#f57900><fn=1> </fn></fc><fn=2>$thermal0$</fn> <fc=#f9cda2></fc> $memory$ <fc=#f9cda2></fc> $cpu$ </fn></fc> }{ <fn=2>$UnsafeStdinReader$ </fn>"
       }
