Config {
    ...
    -- , borderWidth = 0
       ...
       , sepChar = "$"
       , alignSep = "}{"
       , template = "<fc=#aaaaaa><fn=1>$trayer$<fc=#1a1919></fc> $date$ <fc=#1a1919></fc> <fc=#ec0101><fn=1></fn></fc><fn=2> $wifi$</fn> $dynnetwork$ <fc=#1a1919></fc> <fc=#ec0101> </fc><fn=2>$vol$</fn><fn=4>%</fn> <fc=#1a1919></fc> <fc=#ec0101><fn=1> </fn></fc><fn=2>$thermal0$</fn> <fc=#1a1919></fc> $memory$ <fc=#1a1919></fc> $cpu$ </fn></fc> }{ <fn=1>$workspaces$ </fn>"
       }
