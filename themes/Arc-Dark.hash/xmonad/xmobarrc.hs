Config {
    ...
    -- , borderWidth = 0
       ...
       , sepChar = "$"
       , alignSep = "}{"
       , template = "<fc=#b4afb9><fn=1>$trayer$<fc=#101216></fc> $date$ <fc=#101216></fc> <fc=#5da0ee><fn=1></fn></fc><fn=2> $wifi$</fn> $dynnetwork$ <fc=#101216></fc> <fc=#5da0ee> </fc><fn=2>$vol$</fn><fn=4>%</fn> <fc=#101216></fc> <fc=#5da0ee><fn=1> </fn></fc><fn=2>$thermal0$</fn> <fc=#101216></fc> $memory$ <fc=#101216></fc> $cpu$ </fn></fc> }{ <fn=2>$UnsafeStdinReader$ </fn>"
       }
