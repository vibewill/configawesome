Config {
    ...
    -- , borderWidth = 0
       ...
       , sepChar = "$"
       , alignSep = "}{"
       , template = "<fc=#7e57c2><fn=1>$trayer$<fc=#222638></fc> $date$ <fc=#222638></fc> <fc=#c50ed2><fn=1></fn></fc><fn=2> $wifi$</fn> $dynnetwork$ <fc=#222638></fc> <fc=#c50ed2> </fc><fn=2>$vol$</fn><fn=4>%</fn> <fc=#222638></fc> <fc=#c50ed2><fn=1> </fn></fc><fn=2>$thermal0$</fn> <fc=#222638></fc> $memory$ <fc=#222638></fc> $cpu$ </fn></fc> }{ <fn=2>$UnsafeStdinReader$ </fn>"
       }
