...
theme.widget_main_color = "#c50ed2"
...
theme.fg_normal                                 = "#7e57c2"
theme.fg_focus                                  = "#0c0e14"
theme.color_tag                                 = "#474747"
theme.fg_urgent                                 = theme.widget_main_color
theme.bg_normal                                 = "#0c0e14"
theme.bg_focus                                  = "#0c0e14"
theme.bg_task_focus                             = "#02b4cc"
theme.bg_urgent                                 = theme.bg_normal
theme.border_width                              = 1
theme.border_normal                             = "#313131"
theme.border_focus                              = theme.widget_main_color
    ...
    settings = function()
        widget:set_markup(markup.font(theme.font,
                          markup(theme.fg_normal, "" .. net_now.sent)
                            .. "  " ..
                          markup(theme.fg_normal, "" .. net_now.received .. " ")))
    end
})
...
s.mytaglist = awful.widget.taglist(s, awful.widget.taglist.filter.noempty, awful.util.taglist_buttons, {font = "Font Awesome 5 Solid 9", bg_focus = theme.bg_task_focus, fg_focus = theme.fg_focus})
